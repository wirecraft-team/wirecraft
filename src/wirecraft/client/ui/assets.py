...
class Assets(metaclass=AssetsMeta):
    ...
    SWITCH_DEVICE = SvgAsset("switch.svg", (1470, 220), mask=True, positions={i: (i, 0, 0) for i in range(9)})
    PC_DEVICE = SvgAsset("pc.svg", (940, 1570), mask=True, positions={i: (i, 0, 0) for i in range(1)})
